        ...
        <>
            ...
            <div className="flex flex-col items-center  md:w-1/2 p-4 ">
                <div className="flex items-center mb-8">
                    ...
                    <span className="ml-2 text-4xl font-semibold text-[#fff]">Xin chào đến KDP</span>
                </div>
                <div className="bg-[rgb(61,113,226)] p-8 rounded-lg shadow-lg w-full max-w-md">
                    <h2 className="text-2xl font-semibold text-center mb-6 text-bg-light">Đăng nhập</h2>
