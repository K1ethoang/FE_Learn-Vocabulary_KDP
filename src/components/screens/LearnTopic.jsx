...
const LearnTopic = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            <div className='w-full h-20 bg-purple text-bg-light flex items-center justify-between p-6 font-bold text-xl mb-14'>
            <div>Hoc</div>
            <div>Title of topic</div>
            <div className=' w-7 h-7 text-center  border hover:bg-[rgb(181,159,255)] cursor-pointer ' onClick={()=> navigate(-1)}>X</div>
        </div>

        {stillQuestion?
        <>
            <div className='flex w-2/5 h-9 mb-4 text-xl items-center justify-around'>
        ...
        <>
            ...
            <div className='w-80 h-10 flex items-center justify-between mt-12 '>
