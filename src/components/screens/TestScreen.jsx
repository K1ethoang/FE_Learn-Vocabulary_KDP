...
const TestScreen = () => {
    ...
    const [selectedAnswers, setSelectedAnswers] = React.useState(Array(lengthTest).fill(null));
    ...
    return (
        ...
        <div className='flex flex-col items-center w-full min-h-screen bg-[#F0F8FF]'>
            ...
            <div className='w-full min-h-16 bg-[#0056b3] text-bg-light flex items-center justify-between p-3 mb-8'>
                ...
                <div onClick={() => navigate(-1)} className='w-8 h-8 border flex items-center justify-center hover:bg-[#fcb06944] cursor-pointer'>X</div>
            </div>
            ...
            <div className='mb-10'>
                <Button type='primary' size='large' onClick={handleSubmitTest}>Nộp bài</Button>
            </div>
